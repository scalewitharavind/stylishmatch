...
import { Sparkles, Calendar, Menu, X, User, Compass, MessageSquare, Image, Award } from "lucide-react";
...
export default function Navbar({ currentView, setView, bookingCount }: NavbarProps) {
  ...
  const navItems = [
    ...
    { id: "portfolio-search", label: "AI Portfolio", icon: Image },
  ];
          ...
          <div className="pt-2 border-t border-gray-100">
            ...
            >
              <div className="flex items-center space-x-3">
                ...
                <span className="font-sans text-sm font-semibold">User Dashboard</span>
              </div>
              {bookingCount > 0 && (
